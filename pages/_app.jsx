...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.com/oauth2/authorize?client_id=836175725518258186&permissions=8&scope=bot",
    },
       {
      link: true,
      name: "Vote",
      ...
      href: "https://top.gg/bot/836175725518258186/vote",
    },
    {
      link: true,
      name: "Partners",
